...
export function Hero() {
  ...
  return (
    <section className="py-16 sm:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800 bg-[url('https://cdn.dummyjson.com/product-images/fragrances/calvin-klein-ck-one/1.webp')] bg-cover bg-center">
